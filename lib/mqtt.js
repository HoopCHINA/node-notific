...
(function () {
  ...
  Object.defineProperty(Connection.prototype, 'writable', {
    get: function() { return this.stream.writable; }
  });
})();
...
MQTTNotificServer.prototype._handler = function (client) {
  ...
  function _destroy() { client.destroy(); }

  function _destroySoon() { client.destroySoon(); }

  function _destroyWithAck(ack) {
    client.connack({returnCode: ack});
    client.destroySoon();
  }
...
function _makeChannel(client) {
  return {c: client, q: [], a: [], e: 0};
}
